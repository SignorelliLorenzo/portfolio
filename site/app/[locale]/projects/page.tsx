...
function ProjectCard({ project, index, locale }: ProjectCardProps) {
  return (
    ...
    >
      <div className="relative h-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:border-white/20 transition-all duration-300 flex flex-col">
        ...
        <div className="p-6 flex-1 flex flex-col">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            {project.tags && project.tags.length > 3 && (
              <span className="px-2.5 py-1 bg-white/10 text-gray-400 text-xs rounded border border-white/20">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="flex-1 bg-white text-black hover:bg-white/90 px-4 py-2 rounded-lg font-semibold text-sm text-center transition-all duration-200 flex items-center justify-center gap-2"
            >
              Details
            ...
            {project.github && (
              <a
                ...
                className="bg-white/10 hover:bg-white/20 text-white px-3 py-2 rounded-lg transition-all duration-200 flex items-center border border-white/20"
                aria-label="GitHub"
              >
                <FaGithub size={16} />
              </a>
